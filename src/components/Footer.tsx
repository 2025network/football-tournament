  ...
  return (
    <footer id="contact" className="bg-slate-950 px-5 py-10 lg:px-8">
      <div className="mx-auto grid max-w-7xl gap-8 border-t border-white/10 pt-8 lg:grid-cols-[1fr_1.4fr] lg:items-start">
        <div>
          <p className="text-lg font-black text-white">FT Esports</p>
          <p className="mt-2 max-w-md text-sm leading-6 text-slate-400">Professional mobile esports tournaments for players, teams, referees, and organizers.</p>
